...
const Contact: React.FC = () => {
  return (
    <section id="contact" aria-labelledby="contact-title" className="container py-20">
      <div className="mx-auto max-w-6xl rounded-none border border-border/60 bg-card p-8 md:p-10 text-center shadow-sm">
