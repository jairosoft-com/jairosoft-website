  ...
  return (
    <header className="relative isolate overflow-hidden min-h-screen">
      ...
      <nav className="container relative z-10 flex items-center justify-between py-6">
        <a href="/" aria-label="Jairosoft home" className="inline-flex items-center gap-2"><img src="/lovable-uploads/94071b7c-c7a5-4cfb-acd4-6064ff2a66ec.png" alt="Jairosoft logo" className="h-8 w-auto" loading="eager" /><span className="font-montserrat font-extrabold tracking-wide text-white text-4xl">JAIROSOFT</span></a>
