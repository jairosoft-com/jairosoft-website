  ...
  return (
    <header className="relative isolate overflow-hidden min-h-screen">
      ...
      <nav className="container relative z-10 flex items-center justify-between py-6">
        <a href="/" aria-label="Jairosoft home" className="inline-flex items-center gap-2"><img src="/lovable-uploads/cc373cb7-1c4e-4bb4-9313-1c18951cdbfd.png" alt="Jairosoft logo" className="h-8 w-auto" loading="eager" /><span className="font-montserrat font-extrabold tracking-wide text-white text-4xl">JAIROSOFT</span></a>
